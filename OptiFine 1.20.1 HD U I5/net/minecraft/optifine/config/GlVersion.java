...
public class GlVersion
{
    ...
    public String toString() {
        if (this.suffix == null) {
            return invokedynamic(makeConcatWithConstants:(III)Ljava/lang/String;, this.major, this.minor, this.release);
        }
        return invokedynamic(makeConcatWithConstants:(IIILjava/lang/String;)Ljava/lang/String;, this.major, this.minor, this.release, this.suffix);
    }
}
