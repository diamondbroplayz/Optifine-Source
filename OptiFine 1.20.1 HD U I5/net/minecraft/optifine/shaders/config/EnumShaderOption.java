...
public enum EnumShaderOption
{
    ...
    private static /* synthetic */ EnumShaderOption[] $values() {
        return new EnumShaderOption[] { EnumShaderOption.ANTIALIASING, EnumShaderOption.NORMAL_MAP, EnumShaderOption.SPECULAR_MAP, EnumShaderOption.RENDER_RES_MUL, EnumShaderOption.SHADOW_RES_MUL, EnumShaderOption.HAND_DEPTH_MUL, EnumShaderOption.CLOUD_SHADOW, EnumShaderOption.OLD_HAND_LIGHT, EnumShaderOption.OLD_LIGHTING, EnumShaderOption.SHADER_PACK, EnumShaderOption.TWEAK_BLOCK_DAMAGE, EnumShaderOption.SHADOW_CLIP_FRUSTRUM, EnumShaderOption.TEX_MIN_FIL_B, EnumShaderOption.TEX_MIN_FIL_N, EnumShaderOption.TEX_MIN_FIL_S, EnumShaderOption.TEX_MAG_FIL_B, EnumShaderOption.TEX_MAG_FIL_N, EnumShaderOption.TEX_MAG_FIL_S };
    }
